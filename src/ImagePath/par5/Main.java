...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String img1 = "src/ImagePath/par5/imagem9.png";
        String img2 = "src/ImagePath/par5/imagem10.jpeg";
        ...
        ImageIO.write(imagemNova1,"jpg", new File("src/ImagePath/par5/ImagemNovaSoma.jpg"));
        ImageIO.write(imagemNova2,"jpg", new File("src/ImagePath/par5/ImagemNovaOR.jpg"));
        ImageIO.write(imagemNova3,"jpg", new File("src/ImagePath/par5/ImagemNovaAND.jpg"));
        ImageIO.write(imagemNova4,"jpg", new File("src/ImagePath/par5/ImagemNovaXOR.jpg"));
    }
}
