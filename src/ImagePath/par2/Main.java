...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String img1 = "src/ImagePath/par2/imagem2.png";
        String img2 = "src/ImagePath/par2/imagem5.jpg";
        ...
        ImageIO.write(imagemNova1,"jpg", new File("src/ImagePath/par2/ImagemNovaSoma.jpg"));
        ImageIO.write(imagemNova2,"jpg", new File("src/ImagePath/par2/ImagemNovaOR.jpg"));
        ImageIO.write(imagemNova3,"jpg", new File("src/ImagePath/par2/ImagemNovaAND.jpg"));
        ImageIO.write(imagemNova4,"jpg", new File("src/ImagePath/par2/ImagemNovaXOR.jpg"));
    }
}
