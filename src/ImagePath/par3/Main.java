...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String img1 = "src/ImagePath/par3/imagem3.png";
        String img2 = "src/ImagePath/par3/imagem4.jpg";
        ...
        ImageIO.write(imagemNova1,"jpg", new File("src/ImagePath/par3/ImagemNovaSoma.jpg"));
        ImageIO.write(imagemNova2,"jpg", new File("src/ImagePath/par3/ImagemNovaOR.jpg"));
        ImageIO.write(imagemNova3,"jpg", new File("src/ImagePath/par3/ImagemNovaAND.jpg"));
        ImageIO.write(imagemNova4,"jpg", new File("src/ImagePath/par3/ImagemNovaXOR.jpg"));
    }
}
